...
//	
//	
//	SDL_CreateRGBSurfaceFrom((void*)logo,32,32,32,128,0x000000ff,0x0000ff00,0x00ff0000,0);
//#endif
...
int main(int argc, char* argv[]) {
	try {
		// disable dosbox command line !
		for(int i=0;i<argc-1;i++)
		{
			if(i>0)
				strcat(concatenate_argv," ");
			strcat(concatenate_argv,argv[1+i]);
		}
		...
		//printf("powered by DOSBox version %s, copyright 2002-2010 DOSBox Team.",VERSION);
	...
	//printf("Powered by DOSBox version %s (c) 2002-2010 DOSBox Team",VERSION);
